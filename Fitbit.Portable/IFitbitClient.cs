...
namespace Fitbit.Api.Portable
{
    public interface IFitbitClient
    {
        ...
        Task<IntradayData> GetIntraDayTimeSeriesAsync(IntradayResourceType timeSeriesResourceType, DateTime dayAndStartTime, TimeSpan intraDayTimeSpan, DataResolution resolution = DataResolution.OneMinute);
